...
gym.register(
    ...
    kwargs={
        ...
        "rl_games_cfg_entry_point": "isaaclab_tasks.manager_based.manipulation.forge_assembly.config.franka.agents.rl_games_ppo_cfg:FrankaForgeAssemblyRNNPPORunnerCfg",
    },
)
