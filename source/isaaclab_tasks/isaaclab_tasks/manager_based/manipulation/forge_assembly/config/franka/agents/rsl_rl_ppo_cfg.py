...
"""PPO agent configuration for Franka peg-in-hole assembly.
...
@configclass
class FrankaForgeAssemblyRNNPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    """RSL-RL PPO training configuration for Franka peg-in-hole assembly."""

    num_steps_per_env = 512
    max_iterations = 3000
    save_interval = 100
    experiment_name = "forge_assembly_franka"
